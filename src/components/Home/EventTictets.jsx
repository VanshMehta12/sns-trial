...
export default function EventsPage({ sliderData, cityData }) {
    const filteredSliderData2 = sliderData?.filter(
        (ele) => ele.type === "slider" && ele.event_id !== null
    )
                ...
                isLoading ? (
                    ...
                    <div className={styles.body}>
                        <div className={styles.container}>
                            <h4 className="pop_cat_head mb-4 text-center text-xl-start ms-xl-4 ps-xl-3">
                                Trending Events
                            </h4>
