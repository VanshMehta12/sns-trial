        ...
        <>
            <div className="col-12">
                <div className="row formWrapper">
                    ...
                    <div className="col-12">
                        <label className='auth_pers_label' htmlFor="price">{t('price')}</label>
                        <input placeholder={placeholderLabel} value={AdListingDetails.price || 0} name='price' className={`${AdListingDetails.price !== '' ? 'bg' : ''}`} type='number' onChange={handleAdListingChange} />
                    </div>
