...
const Header = () => {
    ...
    return (
        <>
            ...
            <Drawer className='eclassify_drawer' maskClosable={false} title={
                < Image src={settings?.header_logo} width={192} height={62} alt="Close Icon" onErrorCapture={placeholderImage} />
            } onClose={handleClose} open={show} closeIcon={CloseIcon} >
